                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="Restock">
                                                ...
                                                <table class="mt-3">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-1000 fw-bold py-1">Product in stock now:
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-1000 fw-bold py-1">Last time restocked:
                                                            </td>
                                                            <td class="text-700 fw-semi-bold py-1">25th March, 2020
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-1000 fw-bold py-1">Total stock over
                                                                lifetime:
                                                            </td>
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="ps-4">
                                                                <p class="mb-0">Your product, Our
                                                                    responsibility.<br>For
                                                                    a measly fee, we will handle the delivery process
                                                                    for
                                                                    you.</p>
                                                            </div>
                                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <a href="javascript:;" class="btn btn-sm btn-light border shadow-sm">Fashion
                                            <i class="bi bi-x"></i></a>
                                        <a href="javascript:;" class="btn btn-sm btn-light border shadow-sm">Furniture
                                            <i class="bi bi-x"></i></a>
                                    </div>
                                </div>
                                <div class="col-12">
