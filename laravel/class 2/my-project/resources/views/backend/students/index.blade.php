    ...
    <main class="dashboard-content">
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <section class="panel">
                ...
                <div class="d-flex justify-content-end mb-3"><a href="{{ url('/students/create') }}"
                        class="btn btn-success">New Student</a></div>
                        ...
                        <tbody>
                            ...
                            @foreach ($students as $student)
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-media"><img class="product-thumb" src="{{ student->photo }}"
